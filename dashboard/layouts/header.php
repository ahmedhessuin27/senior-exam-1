...
if ($_SESSION['user_type'] != 'admin') {
    ...
    $state2 = "SELECT count(*) AS total FROM register";
    $execute2 = mysqli_query($connection, $state2);
    $count = mysqli_fetch_assoc($execute2);
}
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block user-dropdown">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="rounded-circle header-profile-user" src="../uploads/profile/<?= $data['picture'] ?>" alt="Header Avatar">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item text-danger" href="#"><i class="ri-shut-down-line align-middle me-1 text-danger"></i> <a href="../logout.php">Logout</a></a>
                        </div>
                    </div>
